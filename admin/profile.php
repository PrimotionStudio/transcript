...
const PAGE_TITLE = "Admin Profile - Escrow";
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" action="" method="post">
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Name" name='name' value="<?= $get_admin["name"] ?>">
                </div>
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Email" name='email' value="<?= $get_admin["email"] ?>">
                </div>
                <div class="mb-3">
                  <label>Phone</label>
                  <input type="tel" class="form-control" placeholder="Phone" name="phone" value="<?= $get_admin["phone"] ?>">
                </div>
