...
?>
        <div class="message-bubble <?= $messages['sendUserId'] == $user_id ? 'message-sender' : 'message-receiver' ?>">
            <div>
                ...
                <div class="message-timestamp <?= $messages['sendUserId'] == $user_id ? 'text-white' : 'text-black' ?>">
